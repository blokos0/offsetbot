...
local persist_baserules = {
    "all feeling stop eat all",
    "seldom turnip is yellow",
    "turnip feeling yellow is not yellow",
    "idle all feeling you is fallup",
    "idle all feeling 3d is fallup",
    "idle text feeling you is fallup",
    "often cloud is chill",
    "cloud is chill",
    "all feeling you is purple",
    "text feeling you is purple",
    "tile is more"
}
